...
Image files in this folder are stored in a *year/month/day* folder structure to simplify file browsing and cleanup.

Example: `camknows/camknows/media-files/2022/12/01`
...
## Camera Manual Settings (`manual_*`)
